#ifndef MODEL_EVAL_REF_H
#define MODEL_EVAL_REF_H

#include "../constants_sd.h"
#include "hls_stream.h"
#include "ap_fixed.h"
#include "nn2_cblk1_sd.h"
...
public:
     ...
     * @param model2      Neural network instance
...
void evaluate(hls4csnn1d_cblk_sd::NeuralNetwork2_Cblk1_sd<NUM_STEPS>& model2,
...
#pragma HLS STREAM variable=output_stream depth=FIXED_LENGTH6 // 2
